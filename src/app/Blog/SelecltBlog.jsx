    ...
    <>
      <div className="flex justify-center px-4 py-16 bg-white w-[90%] relative left-[5%]">
        <div className="max-w-4xl mx-auto">
          <h1 className="mb-6 font-bold text-gray-800 lg:text-4xl sm:text-2xl">
            {currentBlog.title}
          </h1>
          <h1 className="mb-6 font-bold text-gray-800 text-md">
            {currentBlog.date}
          </h1>
          <img
          ...
          />{" "}
          <br />
          <p className="text-lg leading-7 text-left text-gray-700">
            {currentBlog.content}
          </p>
          <p className="text-lg leading-7 text-left text-gray-700">
            {currentBlog.summary}
