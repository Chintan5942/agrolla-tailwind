  ...
  // --- Spices ---
{
  ...
  aboutProduct: "Eagle-grade coriander seeds are bold, golden-yellow, and packed with flavor. Sourced from top Indian regions, they are ideal for grinding and use in masalas and seasoning blends.",
  overview: "Coriander Eagle seeds are bold, aromatic, and packed with natural oils—perfect for food manufacturers and spice processors.",
  premiumQuality: "Processed in-house with strict hygiene and quality checks. Packaged to preserve flavor and aroma for export and bulk use.",
  specifications: `
...
},
{
  ...
  aboutProduct: "Scooter-grade coriander seeds offer balance between size and aroma, making them ideal for masala production and dry roasting applications.",
  overview: "Scooter coriander is a mid-grade spice with balanced flavor and consistent oil levels. Widely used in households and factories.",
  premiumQuality: "Sourced from top farms and cleaned using modern facilities to ensure purity and color consistency.",
  specifications: `
• Moisture: 9% Max
• Purity: 98%–99%
• Admixture: 1% Max
...
},
{
  ...
  aboutProduct: "Parrot coriander seeds are compact with a greenish hue and are known for their strong aroma. Perfect for grinding into spice powders.",
  overview: "An affordable yet powerful spice, Parrot-grade coriander is a favorite among home cooks and small-scale food units.",
  premiumQuality: "Processed with care in hygienic facilities. Cleaned and sorted for minimal foreign matter.",
  specifications: `
• Moisture: 9% Max
• Foreign Material: 1% Max
• Purity: 98%–99%
...
},
{
  ...
  aboutProduct: "Double Parrot coriander seeds are premium-grade with superior oil content and color. Ideal for global spice markets and processors.",
  overview: "Preferred for its consistency, high aroma, and strong flavor presence in export blends and branded masalas.",
  premiumQuality: "Carefully selected, polished, and packed to meet stringent export and hygiene standards.",
  specifications: `
• Moisture: 9% Max
• Foreign Matter: 1% Max
• Admixture: 1% Max
...
},
{
  ...
  aboutProduct: "Fada coriander is derived by splitting Eagle seeds. It releases flavor quickly and is perfect for time-efficient cooking and food processing.",
  overview: "Offers convenience with no compromise in aroma or taste. A must-have in fast-paced kitchens.",
  premiumQuality: "Processed from whole Eagle seeds with no loss of oil content. Hygienically packed for freshness.",
  specifications: `
• Cut: Fada (split)
...
},
{
  ...
  applications: "Used in spice blends, curries, marinades, and herbal medicine.",
  aboutProduct: "Cumin seeds are valued for their distinctive flavor and aroma. A staple in Indian, Middle Eastern, and Mexican cuisine.",
  overview: "A key ingredient in garam masala and global spice mixes. Also used in Ayurvedic remedies.",
  premiumQuality: "Sorted and processed using hygienic methods for food-grade and herbal markets.",
  specifications: `
...
},
{
  ...
  rating: 17,
  reviews: 16,
  description: "Sweet and aromatic fennel seeds used in cooking and digestion.",
  highlights: [
  ...
  applications: "Used in herbal teas, desserts, mouth fresheners, and curries.",
  aboutProduct: "Fennel seeds are aromatic and flavorful. Known for their digestion-boosting properties and sweet flavor, they are used widely in food and health applications.",
  overview: "Fennel seeds enhance both flavor and health. They’re refreshing, fragrant, and packed with antioxidants.",
  premiumQuality: "Sourced from top farms and cleaned with advanced optical sorting for purity and visual appeal.",
  specifications: `
• Purity: 99%
• Admixture: 1% Max
• Moisture: 10% Max
...
},
{
  ...
  rating: 16,
  reviews: 14,
  description: "Bitter yet beneficial fenugreek seeds, great for seasoning and health.",
  highlights: [
  ...
  applications: "Used in Indian curries, pickles, spice blends, hair oils, and cosmetics.",
  aboutProduct: "Fenugreek seeds are small golden seeds with strong flavor and therapeutic properties. A key ingredient in Indian spice racks and Ayurvedic formulations.",
  overview: "From cooking to skincare, fenugreek plays a powerful role with its nutrients and bioactive compounds.",
  premiumQuality: "Sorted to 99.9% purity with minimal foreign matter. Available in bulk and custom packaging.",
  specifications: `
• Purity: 99.90%
