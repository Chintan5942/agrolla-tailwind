    ...
    <>
      ...
      >
        ...
        >
          ...
          <h5 className="max-w-[600px] mx-auto text-sm font-semibold leading-relaxed text-center  relative  text-gray-600  md:text-lg ">
            Have questions about our services or products? Contact us today and
            our team will be happy to assist you.
          </h5>
        </div>

        <div className="flex flex-col w-full max-w-screen-xl lg:flex-row gap-x-10 gap-y-10 px-4">
          {/* Left Form */}
          <div
          ...
          >
            {/* Address Section */}
            <div
              className="bg-white rounded-xl shadow-lg py-4 flex flex-col justify-center"
              data-aos="zoom-in-up"
            >
            ...
            {/* Map Section */}
            <div
              className="bg-white rounded-xl shadow-lg h-[300px] flex items-center justify-center"
              data-aos="zoom-in"
            >
