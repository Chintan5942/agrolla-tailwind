...
const isActive = (path) => pathname.toLowerCase() === path.toLowerCase();
  ...
  return (
    <nav className="w-full h-[72px] px-4 md:px-8 flex items-center justify-around bg-[#ffffff] top-0 sticky z-40">
      {/* Logo */}
      <a href="/" className="flex items-center">
        <img src="/agrolla-logo.png" alt="Agrolla Logo" className="w-[85.71px] h-[60px]" />
      </a>
      <div className="hidden md:flex gap-8 text-[#4E4E4E] text-base font-semibold">
...
{/* Mobile  */}
      {isOpen && (
        <div className="absolute top-[72px] left-0 w-full bg-white shadow-md flex flex-col items-center gap-4 py-4 z-50 text-[#4E4E4E] text-base font-semibold">
