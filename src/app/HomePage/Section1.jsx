  ...
  export default function Section1() {
    return (
      <>
        <div className="h-[863px] w-[1920px(fixed)] border-2 border-amber-700 overflow-hidden  section1">
          ...
          <div className="h-[488px] w-[1437px]  relative left-[288px] top-[150px] flex flex-wrap flex-col overflow-hidden">
              ...
              />
              <div className="h-[88px] w-[311px] relative top-[-300px] left-130">
              ...
              <div className="h-[136px] w-[445px]  relative top-90 left-10">
                <p className="text-[#111827] font-medium text-xl text-left">
                  Competitive Pricing
                </p>
                <p className="text-[#4B5563] font-normal text-base text-left">
