                ...
                <div className="relative">
                  ...
                  >
                    {Object.keys(categoryImages).map((cat) => (
                      <option key={cat} value={cat} className="text-lg text-center font-regular">
                        {cat}
                      </option>
                    ))}
                  </select>
            ...
            <section className="w-full lg:w-[80%] grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-6 p-2 catagory-section h-[980px]">
              {filteredProducts.map((product) => {
                ...
                return (
                  <div
                    key={product.id}
                    className="bg-white rounded-2xl h-[450px] card cursor-pointer relative flex flex-col justify-between"
                  >
                    <img
                      src={product.image}
                      alt={product.title}
